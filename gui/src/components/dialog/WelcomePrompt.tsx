...
export default function WelcomePrompt(props: WelcomePromptProps) {
	...
	return (
		<ModalBase visible={props.visible} onClose={() => {}} width="40rem">
			<div id="welcome-prompt">
				<div
					id="welcome-prompt-tabs"
					style={`grid-template-columns:repeat(3,minmax(0,1fr))`}
				>
					<div
						class={`cont welcome-prompt-tab ${
							tab() == 0 ? "selected" : ""
						} first`}
				...
				<div
					class={`cont col ${tab() == 1 ? "start" : ""}`}
					id="welcome-prompt-contents"
				>
					<Show when={tab() == 0}>
						<div class="cont col" style="width:80%;text-align:center">
							...
							<span style="color:var(--fg2)">
								This includes features like modloader installation, Modrinth
								integration, and importing from other launchers.
							</span>
						</div>
						<br />
						<div class="cont">
					...
					<Show when={tab() == 2}>
						<span class="bold">Welcome to Nitrolaunch!</span>
					</Show>
				</div>
