...
- `modrinth_id`: ID of the project for this package on Modrinth, if applicable.
- `curseforge_id`: ID of the project for this package on CurseForge, if applicable.
- `smithed_id`: ID of the project for this package on Smithed, if applicable.
